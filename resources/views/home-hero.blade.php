                ...
                <div class="nav-icon-wrapper d-none" id="userSection">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="/profile" onclick="showProfile()"><i class="fas fa-user me-2"></i>Profile</a></li>
                            <li><a class="dropdown-item" href="/orders" onclick="showOrders()"><i class="fas fa-shopping-bag me-2"></i>My Orders</a></li>
                            <li><a class="dropdown-item" href="/wishlist" onclick="showWishlist()"><i class="fas fa-heart me-2"></i>Wishlist</a></li>
                            <li><a class="dropdown-item" href="/settings" onclick="showSettings()"><i class="fas fa-cog me-2"></i>Settings</a></li>
