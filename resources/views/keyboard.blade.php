...
<head>
    ...
    <title>Keyboards - DND COMPUTERS</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="hero-section">
                <h1 class="hero-title">Premium Keyboards</h1>
                <p class="hero-subtitle">
                    Discover mechanical and wireless keyboards designed for gaming, productivity, and professional use.
                </p>
            </div>
            ...
            <div class="coming-soon">
                ...
                <h3>Keyboards Coming Soon!</h3>
                <p>
                    We're curating an amazing collection of premium keyboards including mechanical gaming keyboards, 
                    wireless productivity keyboards, and professional typing solutions. Stay tuned for the best deals 
                    on top brands like Corsair, Razer, Logitech, and more.
                </p>
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="text-center mb-4" style="color: #ffc107; font-weight: 700;">Featured Keyboard Categories</h2>
                </div>
            </div>
            ...
            <div class="product-grid">
                <div class="product-card">
                    <img src="https://images.pexels.com/photos/2115256/pexels-photo-2115256.jpeg?auto=compress&cs=tinysrgb&w=400" 
                         ...
                         class="product-image">
                    <h5 class="product-title">Mechanical Gaming Keyboards</h5>
                    <div class="product-brand">RGB Backlit</div>
                    <div class="product-price">Starting at $89.99</div>
                    <p class="product-description">
                        High-performance mechanical switches with customizable RGB lighting for the ultimate gaming experience.
                    </p>
                ...
                <div class="product-card">
                    <img src="https://images.pexels.com/photos/1772123/pexels-photo-1772123.jpeg?auto=compress&cs=tinysrgb&w=400" 
                         ...
                         class="product-image">
                    <h5 class="product-title">Wireless Keyboards</h5>
                    <div class="product-brand">Bluetooth & 2.4GHz</div>
                    <div class="product-price">Starting at $49.99</div>
                    <p class="product-description">
                        Clean, wireless setup with long battery life and reliable connectivity for productivity and gaming.
                    </p>
                    <button class="add-to-cart-btn" disabled>
                        <i class="fas fa-clock me-2"></i>Coming Soon
                    </button>
                ...
                <div class="product-card">
                    <img src="https://images.pexels.com/photos/1772123/pexels-photo-1772123.jpeg?auto=compress&cs=tinysrgb&w=400" 
                         ...
                         class="product-image">
                    <h5 class="product-title">Compact Keyboards</h5>
                    <div class="product-brand">60% & TKL</div>
                    <div class="product-price">Starting at $69.99</div>
                    <p class="product-description">
                        Space-saving designs without compromising on functionality. Perfect for minimalist setups.
                    </p>
                    <button class="add-to-cart-btn" disabled>
                        <i class="fas fa-clock me-2"></i>Coming Soon
                    </button>
                ...
                <div class="product-card">
                    <img src="https://images.pexels.com/photos/2115256/pexels-photo-2115256.jpeg?auto=compress&cs=tinysrgb&w=400" 
                         ...
                         class="product-image">
                    <h5 class="product-title">Professional Keyboards</h5>
                    <div class="product-brand">Office & Business</div>
                    <div class="product-price">Starting at $39.99</div>
                    <p class="product-description">
                        Comfortable typing experience for long work sessions with ergonomic design and quiet operation.
                    </p>
                    <button class="add-to-cart-btn" disabled>
                        <i class="fas fa-clock me-2"></i>Coming Soon
                    </button>
            ...
            <div class="coming-soon">
                <h3>Stay Updated</h3>
                <p>Be the first to know when our keyboard collection launches!</p>
    ...
    <script>
        function notifyMe() {
            showNotification('Thank you! We\'ll notify you when keyboards are available.', 'success');
        }
